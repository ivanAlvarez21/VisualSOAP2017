...
namespace AccesoDatosDs {
    ...
    public partial class DataSetNorthWind : global::System.Data.DataSet {
        ...
        public partial class CustomerCustomerDemoDataTable : global::System.Data.TypedTableBase<CustomerCustomerDemoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerCustomerDemoRow AddCustomerCustomerDemoRow(string CustomerID, string CustomerTypeID) {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
    ...
    public partial class CustomerCustomerDemoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [CustomerCustomerDemo] WHERE (([CustomerID] = @Original_CustomerID) A" +
                "ND ([CustomerTypeID] = @Original_CustomerTypeID))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [CustomerCustomerDemo] ([CustomerID], [CustomerTypeID]) VALUES (@Cust" +
                "omerID, @CustomerTypeID);\r\nSELECT CustomerID, CustomerTypeID FROM CustomerCustom" +
                "erDemo WHERE (CustomerID = @CustomerID) AND (CustomerTypeID = @CustomerTypeID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CustomerCustomerDemo] SET [CustomerID] = @CustomerID, [CustomerTypeID] = @CustomerTypeID WHERE (([CustomerID] = @Original_CustomerID) AND ([CustomerTypeID] = @Original_CustomerTypeID));
SELECT CustomerID, CustomerTypeID FROM CustomerCustomerDemo WHERE (CustomerID = @CustomerID) AND (CustomerTypeID = @CustomerTypeID)";
        ...
        private void InitConnection() {
            this._connection = new global::System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = global::AccesoDatosDs.Properties.Settings.Default.NorthwindConnectionString2;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        CustomerID, CustomerTypeID\r\nFROM            CustomerCustomerDemo";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        CustomerID, CustomerTypeID\r\nFROM            CustomerCustomerDemo";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSetNorthWind.CustomerCustomerDemoDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSetNorthWind.CustomerCustomerDemoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetNorthWind.CustomerCustomerDemoDataTable dataTable = new DataSetNorthWind.CustomerCustomerDemoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy(DataSetNorthWind.CustomerCustomerDemoDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetNorthWind.CustomerCustomerDemoDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSetNorthWind.CustomerCustomerDemoDataTable dataTable = new DataSetNorthWind.CustomerCustomerDemoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetNorthWind.CustomerCustomerDemoDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
